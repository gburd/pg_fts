...
| `RESULTS_KNOWN_ISSUES_2026-09-14.md` | The open bulk-ingest bloat issue: mechanism measured (freed pages fail the XID gate in their own transaction), 31% mitigation shipped in 1.7.2, and the retraction of the "one WAL record per page" claim. |
