...
- **Instance id**: `REDACTED-INSTANCE` (r7i.4xlarge = 16 vCPU / 128 GiB,
  us-east-2, owner=gburd-agent, Name=pgfts-prof-20260714-084104). Per-session
  keypair `pgfts-prof-20260714-084104`, SG `REDACTED-SG`
  ...
  IdentitiesOnly=yes.)
- **TERMINATED**: yes — `REDACTED-INSTANCE` confirmed `terminated`, SG + keypair
